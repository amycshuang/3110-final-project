...
Oh no! Your OCaml environment looks broken to me ;( 
Check the error messages above carefully to determine what is
wrong with your environment.  Please see a consultant for help
if you cannot determine what is wrong.
=============================================================
EOF
fi
